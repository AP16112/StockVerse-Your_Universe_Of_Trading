    ...
    export default function Stats() {
        return ( 
            ...
            <div className="container px-2 pt-3 pb-3 mb-5 border-top">
                <div className="row pt-5 pb-5">
                    <div className="col-6 p-5">
                        {/* Here fs-2 means that we are setting the font size to 2 for this h1 heading */}
                        <h1 className="fs-2 mb-5">Trust with confidence</h1>
                        <h2 className="fs-4">Customer‑first always</h2>
                        <p className="text-muted">StockVerse is a student-built learning webapp inspired by real trading platforms (like Zerodha). It prioritises clean user experience while demonstrating common trading workflows.</p>

                        <h2 className="fs-4">Demo & learning only</h2>
                        <p className="text-muted">This project is for education and demo purposes only. It is not affiliated with or endorsed by any brokerage. Do not use it with real funds — it’s intended to explore UI, data flows, and learning scenarios.</p>
                    ...
                    <div className="col-6 p-5">
                        ...
                        <img src="media/images/trust_ecosystem.png" style={{width:'100%'}} ></img>
