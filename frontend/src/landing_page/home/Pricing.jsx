        ...
        <div className="container mb-5">
            <div className="row">
                <div className="col-4">
                    ...
                    <a href=""  style={{textDecoration:"none", color:'#387ed1', fontWeight:'500'}}  >See pricing  <i class="fa-solid fa-arrow-right"></i></a>
                </div>
                ...
                <div className="col-6 mb-5">
                    <div className="row text-center">
                        ...
                        <div className="col-6 p-3 border">
                            <h1 className="mb-3"><i class="fa-solid fa-indian-rupee-sign" style={{fontSize:'2.2rem'}}></i>20</h1>
