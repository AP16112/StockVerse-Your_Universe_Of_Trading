// Here we are creating this 'LeftSection' component to be used in the features section of our application.
...
export default function LeftSection({imageURL, featureName, featureDescription, tryDemo, learnMore, googlePlay, appStore}) {
    return ( 
        <div className="container">
            <div className="row mt-3 mb-5">
                ...
                <div className="col-5 mt-5 p-5">
                    <h1 className="mb-3 fs-2">{featureName}</h1>
