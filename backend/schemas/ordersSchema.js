// Here in this file, we will define the schema for the Orders model using Mongoose. This schema will outline the structure of the data that will be stored in the MongoDB database for orders, including fields such as name, quantity, price, and any other relevant information.
...
// Define the schema for the Orders model
...
// Now we will export the ordersSchema so that it can be used in other parts of our application. This will allow us to create a Mongoose model based on this schema, which we can then use to interact with the orders data in our MongoDB database.
